package br.com.rhomulomourao.todolist.task;
...
import br.com.rhomulomourao.todolist.utils.Utils;
...
public class TaskController {
    ...
    public ResponseEntity update(@RequestBody TaskModel taskModel, @PathVariable UUID id, HttpServletRequest request ){
        ...
        if(task == null){
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Essa tarefa nao existe");
        }
